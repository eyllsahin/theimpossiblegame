# File: res://scripts/Quanta.gd
# Attach to the root CharacterBody2D of res://scenes/quanta.tscn
...
enum STATES { IDLE, WALK, JUMP, PUNCH, KICK, BLOCK, HURT, DIE, VICTORY, TIMEOVER }
var state: STATES = STATES.IDLE
var previous_state: STATES = STATES.IDLE

# AI variables
var ai_timer: float = 0.0
var ai_action_delay: float = 1.0
...
func setup_hitboxes():
	...
	punch_shape.size = Vector2(100, 70)
	...
	kick_shape.size = Vector2(120, 60)
	...
	hurt_shape.size = Vector2(80, 160)
	hurt_collision.shape = hurt_shape
	hurt_collision.position = Vector2(0, -80)
...
func update_hitbox_positions():
	...
	if facing_right:
		punch_hitbox.position = Vector2(90, -70)
		kick_hitbox.position = Vector2(100, -30)
	else:
		punch_hitbox.position = Vector2(-90, -70)
		kick_hitbox.position = Vector2(-100, -30)
...
func perform_punch():
	...
	get_tree().create_timer(0.1).timeout.connect(func(): 
		if state == STATES.PUNCH:
			...
			print("Quanta punch hitbox enabled!")
	)
	get_tree().create_timer(0.25).timeout.connect(func(): 
		punch_hitbox.monitoring = false
		print("Quanta punch hitbox disabled!")
	)
...
func perform_kick():
	...
	get_tree().create_timer(0.15).timeout.connect(func(): 
		if state == STATES.KICK:
			...
			print("Quanta kick hitbox enabled!")
	)
	get_tree().create_timer(0.35).timeout.connect(func(): 
		kick_hitbox.monitoring = false
		print("Quanta kick hitbox disabled!")
	)

func _on_animation_finished():
	print("Quanta animation finished: ", sprite.animation)
...
func take_damage(damage: float):
	...
	print("Quanta health: ", current_health)
...
func play_victory() -> void: 
	if has_animation("victory") and sprite.animation != "victory":
		sprite.play("victory")
